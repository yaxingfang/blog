...
![在这里插入图片描述](https://yaxingfang-typora.oss-cn-hangzhou.aliyuncs.com/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1RoaW5rV29u,size_16,color_FFFFFF,t_70.png)
...
Linux 支持 5 种文件类型，如下图所示：![文件类型](https://yaxingfang-typora.oss-cn-hangzhou.aliyuncs.com/format,png.png)
...
![Linux的目录结构](https://yaxingfang-typora.oss-cn-hangzhou.aliyuncs.com/format,png-20230125135806288.png)
...
![img](https://yaxingfang-typora.oss-cn-hangzhou.aliyuncs.com/format,png-20230125135806349.png)
